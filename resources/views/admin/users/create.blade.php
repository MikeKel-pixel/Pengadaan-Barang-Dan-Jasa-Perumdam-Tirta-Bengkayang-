...
<head>
    ...
    <title>Tambah User - Admin PERUMDAM</title>
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-200">Tambah User</p>
                    </div>
                </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-xs mt-1">
                        ...
                        Admin: akses penuh | Pengadaan: buat pengajuan | Pimpinan: approval | Vendor: penawaran | User: lihat publik
                    </p>
                </div>
