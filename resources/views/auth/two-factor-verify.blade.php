...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500">Masukkan kode 6 digit dari aplikasi authenticator</p>
        </div>
        ...
        <form action="{{ route('two-factor.verify.submit') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label class="block text-gray-700 font-medium mb-2">Kode Verifikasi</label>
                <input type="text" name="code" placeholder="Masukkan 6 digit kode" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-center text-2xl font-bold"
        ...
        <div class="mt-4 text-center text-sm text-gray-500">
            <p>Butuh bantuan? Hubungi administrator.</p>
        </div>
    </div>
</body>
</html>